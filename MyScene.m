...
-(void) activateJointRope{
    ...
    _myRopeJoint = [SKPhysicsJointPin jointWithBodyA:_mySquare1.physicsBody bodyB:_mySquare2.physicsBody anchor:_mySquare1.position];
...
-(void) spawnSquares{
    ...
    _mySquare6 =[[SKSpriteNode alloc]initWithColor:[SKColor blueColor] size:CGSizeMake(30, 30)];
    _mySquare7 =[[SKSpriteNode alloc]initWithColor:[SKColor cyanColor] size:CGSizeMake(30, 30)];
    _mySquare8 =[[SKSpriteNode alloc]initWithColor:[SKColor blackColor] size:CGSizeMake(30, 30)];
    ...
    [_mySquare5 setPosition:CGPointMake(self.size.width/1.5, self.size.height/2)];
    [_mySquare6 setPosition:CGPointMake(self.size.width/1.5, self.size.height/2.2)];
    [_mySquare7 setPosition:CGPointMake(self.size.width/1.5, self.size.height/2.4)];
    [_mySquare8 setPosition:CGPointMake(self.size.width/1.5, self.size.height/2.6)];
...
-(void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event {
    ...
    for (UITouch *touch in touches) {
        ...
        [_mySquare7 setPosition:_mySquare6.position];
        [_mySquare6 setPosition:_mySquare5.position];
        [_mySquare5 setPosition:_mySquare4.position];
        [_mySquare4 setPosition:_mySquare3.position];
        [_mySquare3 setPosition:_mySquare2.position];
        [_mySquare2 setPosition:_mySquare1.position];*/
